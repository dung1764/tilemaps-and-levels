...
namespace myTiles {
    ...
    helpers.registerTilemapFactory(function(name: string) {
        switch(helpers.stringTrim(name)) {
            case "level": return tiles.createTilemap(hex`0a00080002050514050514050509030101010101010101080b01100101010111010816010101010101010115030101010101010a010803010112010101010108040606130606130606070f0c0d0c0c0c0c0c0e0c`, img`
2 2 2 2 2 2 2 2 2 2 
2 . . . . . . . . 2 
. . . . . . . . . 2 
2 . . . . . . . . 2 
...
2 2 2 2 2 2 2 2 2 2 
. . . . . . . . . . 
`, [myTiles.transparency16,sprites.dungeon.floorLight2,sprites.dungeon.purpleOuterNorthWest,sprites.dungeon.purpleOuterWest0,sprites.dungeon.purpleOuterSouthEast,sprites.dungeon.purpleOuterNorth1,sprites.dungeon.purpleOuterSouth1,sprites.dungeon.purpleOuterSouthWest,sprites.dungeon.purpleOuterEast0,sprites.dungeon.purpleOuterNorthEast,sprites.dungeon.stairLarge,sprites.dungeon.stairWest,sprites.dungeon.floorDark0,sprites.dungeon.floorDark5,sprites.dungeon.floorDark3,sprites.dungeon.floorDark1,sprites.dungeon.floorLight5,sprites.dungeon.floorLight4,sprites.dungeon.floorLight3,sprites.dungeon.purpleOuterSouth2,sprites.dungeon.purpleOuterNorth2,sprites.dungeon.purpleOuterEast2,sprites.dungeon.purpleOuterWest2], TileScale.Sixteen)
            case "level1": return tiles.createTilemap(hex`0a0008000509090d09090d0909080a120202020202020b070a0201010101010101070f02021002020202010e0a010101010111020107130202020202020202070604040c04040c04040301010101010101010101`, img`
2 2 2 2 2 2 2 2 2 2 
2 . . . . . . . . 2 
2 . 2 2 2 2 2 2 2 2 
2 . . . . . . . 2 2 
